ALTER TABLE "event_rsvp_responses" ADD COLUMN "invitation_email_status" text DEFAULT 'unsent' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "event_rsvp_responses" ADD COLUMN "invitation_email_queued_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "event_rsvp_responses" ADD COLUMN "invitation_email_sent_at" timestamp with time zone;--> statement-breakpoint
CREATE INDEX "idx_event_rsvp_responses_invitation_email_status" ON "event_rsvp_responses" USING btree ("invitation_email_status");--> statement-breakpoint
