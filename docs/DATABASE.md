...
- `src/db/events-and-participation.ts`: Defines events, user profiles, event applications, user interests/dietary (user-level), event attendees, and application views
