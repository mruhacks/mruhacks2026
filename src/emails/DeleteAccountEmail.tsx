...
export function DeleteAccountEmail({ url, baseUrl }: Props) {
  return (
    <EmailLayout preview="Action required: confirm your MRUHacks account deletion." baseUrl={baseUrl}>
      <Heading style={h1}>Confirm account deletion</Heading>
      <Text style={body}>
        We received a request to <strong>permanently delete</strong> your MRUHacks account. Click the button below to confirm.
      </Text>
      <Text style={warning}>
        <strong>This action is irreversible.</strong> Your account, profile, and all associated data will be erased immediately upon confirmation.
      </Text>
      <Text style={muted}>
        This link is valid for 24 hours. If you did not request account deletion, you can safely ignore this email — no changes will be made.
      </Text>
