...
export function ResetPasswordEmail({ url, baseUrl }: Props) {
  return (
    <EmailLayout preview="Reset your MRUHacks account password." baseUrl={baseUrl}>
      <Heading style={h1}>Reset your password</Heading>
      <Text style={body}>
        We received a request to reset the password for your MRUHacks account. Click the button below to choose a new password. This link expires in 1 hour.
      </Text>
      <Text style={muted}>
