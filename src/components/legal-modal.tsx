  ...
  return (
    ...
    >
      <DialogContent className='max-h-[85vh] overflow-y-auto sm:max-w-2xl'>
        ...
        <div className='[&_a]:text-primary [&_p]:text-foreground/90 space-y-6 text-sm/relaxed [&_a]:underline [&_h2]:mt-6 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:tracking-tight [&_li]:ml-1 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6'>
          {children}
        </div>
      </DialogContent>
    </Dialog>
